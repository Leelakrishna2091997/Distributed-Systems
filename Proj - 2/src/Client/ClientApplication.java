...
public class ClientApplication {
  ...
  private static RPCMethods remoteMethods;

  public ClientApplication() throws NotBoundException, MalformedURLException, RemoteException {
    this.remoteMethods = (RPCMethods) Naming.lookup("rmi://localhost/RMI");
      ...
      switch (operation.toUpperCase()) {
        case "PUT":
          if (key == "" || value == ""){
            ...
            if (res == null) {
              ...
              log.log(Level.INFO,"Insertion of Key Value Success - Key " + key + " Packet id " +  String.valueOf(timestamp));
            }
          }
          break;
          case "GET":
        ...
        case "DELETE":
          ...
          if(deleteRes == null) {
            ...
            log.log(Level.INFO,"Deletion successful." + key);
          }
          break;
        default:
